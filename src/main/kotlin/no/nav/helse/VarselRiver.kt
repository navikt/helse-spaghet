    ...
    override fun onPacket(packet: JsonMessage, context: MessageContext) {
        ...
        packet["aktiviteter"]
            ...
            .forEach { aktivitet ->
                ...
                insertVarsel(vedtaksperiodeId, varselkode, nivå, melding, opprettet)
                log.info("Lagret funksjonell feil på vedtaksperiode $vedtaksperiodeId")
            }
    }

    private fun insertVarsel(
        ...
        sessionOf(dataSource).use { session ->
            @Language("PostgreSQL")
            val query =
                """INSERT INTO varsel(vedtaksperiode_id, varselkode, nivå, melding, opprettet) VALUES(:vedtaksperiode_id, :varselkode, :nivaa, :melding, :opprettet)"""
            session.run(
                queryOf(
                    query, mapOf(
