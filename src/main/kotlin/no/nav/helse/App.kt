...
fun main() {
    ...
    RapidApplication
        .create(env.raw, meterRegistry = meterRegistry)
...
internal fun <T : RapidsConnection> T.setupRivers(
    ...
    AnmodningOmForkastingRiver(this, dataSource)
}

private fun RapidsConnection.setupMigration(dataSourceBuilder: DataSourceBuilder) =
    apply {
        register(
